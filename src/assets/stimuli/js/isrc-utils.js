...
var isrcUtils = {
    ...
    Setup: function () {
        ...
        //isrc-embedded-mode
        if (localStorage.getItem("isrc-embedded-mode") !== null) {
            console.log('ISRC: embedded mode');
            isrcUtils.data.uid = localStorage.getItem("isrc-embedded-mode-uid");
    ...
    SaveData: function() {
        ...
        //isrc-embedded-mode
		if (localStorage.getItem("isrc-embedded-mode") !== null) {
			console.log('ISRC: embedded mode, saving data');
			localStorage.setItem('isrc-embedded-mode-data', JSON.stringify(isrcUtils.data));
			localStorage.setItem("isrc-embedded-mode-ended", "true");
		}
